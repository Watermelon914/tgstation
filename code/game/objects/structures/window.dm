...
/obj/structure/window/paperframe
	...
	var/static/mutable_appearance/torn = mutable_appearance('icons/obj/smooth_structures/normal/structure_variations.dmi',icon_state = "paper-torn", layer = ABOVE_OBJ_LAYER - 0.1)
	var/static/mutable_appearance/paper = mutable_appearance('icons/obj/smooth_structures/normal/structure_variations.dmi',icon_state = "paper-whole", layer = ABOVE_OBJ_LAYER - 0.1)
