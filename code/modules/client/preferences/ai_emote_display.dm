...
#ifdef WALLENING
		return icon('icons/obj/machines/wallening/status_display.dmi', GLOB.ai_status_display_emotes[value])
#else
		return icon('icons/obj/machines/normal/status_display.dmi', GLOB.ai_status_display_emotes[value])
#endif
